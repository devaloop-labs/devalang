...
export interface InitOutput {
  ...
  readonly closure590_externref_shim: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h65e60b84a6cb1bad: (a: number, b: number) => void;
  readonly closure647_externref_shim: (a: number, b: number, c: any, d: any) => void;
