...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h8407cda81079c09a: (a: number, b: number) => void;
  readonly closure1080_externref_shim: (a: number, b: number, c: any, d: any) => void;
